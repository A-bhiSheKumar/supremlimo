    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <img 
              ...
              alt="Luxury Mercedes on highway" 
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Experience the red carpet treatment with our VIP services. We understand the needs of important travelers and ensure maximum privacy, security and comfort.
            </p>
          </div>
        </div>
      </section>

      {/* Employees and Workers Section */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-lg mb-8">
              A team of skilled mechanics meticulously maintains our automobiles. Regular inspections and maintenance ensure that each car is in excellent shape.
            </p>
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Our limos transcend refinement for customers seeking the pinnacle of luxury. These automobiles are in a class of their own, with luxurious interiors and meticulous attention to detail.
            </p>
          </div>
          <div>
            <img 
              ...
              className="w-full h-[700px] object-cover rounded-lg shadow-xl sticky top-8"
            />
          </div>
        </div>
      </section>

      {/* Areas of Operation & Ecological Services */}
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            <img 
              src="https://images.unsplash.com/photo-1549399542-7e3f8b79c341?q=80&w=1000" 
              alt="Luxury car in snow" 
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto bg-gray-50">
        ...
        <p className="text-gray-600 leading-relaxed text-lg max-w-3xl">
          Looking for long distance Transfers? Familiarize yourself with the following transit options.
        </p>
      </section>
